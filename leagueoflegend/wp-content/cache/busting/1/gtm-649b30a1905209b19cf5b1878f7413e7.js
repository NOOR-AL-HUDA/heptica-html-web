(function () {
  ...
  var kc = {
    Ig: function (a, b) {
      b[rb.Rd] &&
        "string" === typeof a &&
        (a = 1 == b[rb.Rd] ? a.toLowerCase() : a.toUpperCase());
  ...
  He.Gh = "";
  He.Cf =
    "ChEI8LrWggYQoqCD5rmBoJ7bARInAAsRUAkXMC2gpV2PmPcxKRo6nYj3Wz0jOgkM/hxJbRtJyfd/EaPcGgLlEA\x3d\x3d";
  var Je = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  function pf(a, b, c) {
    for (var d = [], e = of(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(k)) {
        ...
        l &&
          ((l = l.split("-")),
          d.push({ id: h.join("."), uc: 1 * l[0] || 1, Nb: 1 * l[1] || 1 }));
      }
    }
    return d;
  }
  ...
  var Df = function () {
      for (
        var a = cd.userAgent + (H.cookie || "") + (H.referrer || ""),
          b = a.length,
          c = G.history.length;
        0 < c;
        ...
        a += c-- ^ b++;
      return [
        Math.round(2147483647 * Math.random()) ^ (lf(a) & 2147483647),
        Math.round(Va() / 1e3),
      ].join(".");
    },
  ...
  function vg() {
    ...
    for (var c = 0; c < a.length; c++) {
      ...
      "1" == d[0] &&
        ...
        d[1] &&
        (b[a[c].Ld] || (b[a[c].Ld] = []),
        b[a[c].Ld].push({ timestamp: d[1], Ia: d[2] }));
    }
    return b;
  }
  var wg = /^\w+$/,
    xg = /^[\w-]+$/,
    yg = /^~?[\w-]+$/,
    zg = { aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp", gb: "_gb" },
    Ag = function () {
    ...
    Cg = function (a) {
      ...
      for (var d = {}, e = 0; e < c.length; d = { kb: d.kb }, e++) {
        d.kb = Eg(c[e]);
        var f = Fg(c[e]);
        if (d.kb && f) {
          var h = Ha(
  ...
  function Lg(a, b, c, d) {
    ...
    a.ha && e("ha", n(a.ha[0]));
    a.gp && e("gp", n(a.gp[0]));
    (void 0 == tg.enable_gbraid_cookie_write
      ? 0
      : tg.enable_gbraid_cookie_write) &&
      !k &&
      a.gb &&
      e("gb", n(a.gb[0]));
  }
        ...
        for (var d = Hg(b.prefix), e = 0; e < a.length; ++e) {
          ...
          if (void 0 !== zg[f]) {
            ...
            if (k) {
              ...
              b: {
                for (
                  var q = l, p = of(h, H.cookie, void 0, "ad_storage"), r = 0;
                  r < p.length;
                  ++r
                )
                  if (Fg(p[r]) > q) {
  ...
  var kh = function (a, b, c) {
      ...
      G[a.functionName] = d;
      if (a.nc)
        for (var e = 0; e < a.nc.length; e++) G[a.nc[e]] = G[a.nc[e]] || jh();
        ...
        for (
          ...
          ph[h.id] ||
            (h && "AW" === h.prefix && !e.adData && 2 <= h.F.length
              ? ((e.adData = { ak: h.F[0], cl: h.F[1] }), (ph[h.id] = !0))
              : h &&
                "UA" === h.prefix &&
                !e.gaData &&
                ((e.gaData = { gaWpid: h.containerId }), (ph[h.id] = !0)));
        }
          ...
          if (!d || e) {
            ...
            if (l) {
              ...
              for (var x = 0; x < n.length; x++)
                if (x < v)
                  if (d) rh(d, n[x], u, { va: t, options: r });
                  else if ("AW" === a.prefix && a.F[1])
                    sh()
                      ? rh([a], n[x], u || "US", { va: t, options: r })
                      : qh(a.F[0], a.F[1], n[x], { va: t, options: r });
                  else if ("UA" === a.prefix)
                    if (sh()) rh([a], n[x], u || "US", { va: t });
                    else {
                      var A = a.containerId,
                        w = n[x],
                        y = { va: t };
  ...
  function Sh(a) {
    if (!Lh) {
      ...
      if (!a || "readystatechange" != a.type || c || (!b && d)) {
        Lh = !0;
        for (var e = 0; e < Nh.length; e++) I(Nh[e]);
      }
      Nh.push = function () {
  ...
  var si = function () {
    ...
    ui = function () {
      ...
      void 0 === yi ||
        ...
        (Ci[yi] || Di.eh() || 0 >= Ei--
          ? (D(1), (Ci[yi] = !0))
          : (Di.vh(), jd(ti()), (zi[yi] = !0), (Fi = Gi = Hi = Bi = Ai = "")));
    },
    ti = function () {
      var a = yi;
      if (void 0 === a) return "";
  ...
  function Ri(a, b, c, d) {
    ...
    if (n && n.length) {
      var q = n[0],
        p = Qi(q.index, { onSuccess: h, onFailure: k, terminate: l }, c, d);
      if (!p) return null;
      h = p;
      k = 2 === q.Ye ? l : p;
    }
  ...
  var Yi = function (a, b) {
    for (var c = [], d = 0; d < Vb.length; d++)
      if (a[d]) {
        ...
        var f = ai(b.Oa);
        try {
          var h = Qi(d, { onSuccess: f, onFailure: f, terminate: f }, b, d);
          if (h) {
            var k = c,
              l = k.push,
              n = d,
            ...
            var p = Xb[q];
            l.call(k, { tf: n, kf: p ? p.priorityOverride || 0 : 0, Sg: h });
          } else Wi(d, b), f();
        } catch (t) {
          f();
        }
    ...
    r.o >= r.C && Zh(r);
    c.sort(Xi);
    for (var u = 0; u < c.length; u++) c[u].Sg();
    return 0 < c.length;
  };
  function Xi(a, b) {
    var c,
  ...
  Vc("Edge");
  !Vc("Gecko") ||
    (-1 != Sc.toLowerCase().indexOf("webkit") && !Vc("Edge")) ||
    Vc("Trident") ||
    Vc("MSIE") ||
    Vc("Edge");
        ...
        if (a.purpose && a.vendor) {
          ...
          l =
            ...
            ("DE" === a.publisherCC || (td(1936) && "CH" === a.publisherCC))
              ? !0
              : n && Gj(a.purpose.consents, b);
        } else l = !0;
      else
        l =
          1 === k
            ? a.purpose && a.vendor
              ? Gj(a.purpose.legitimateInterests, b) &&
                Gj(a.vendor.legitimateInterests, void 0 === d ? "755" : d)
              : !0
            : !0;
      return l;
    },
  ...
  var Jj = !0;
  var Kj = { 1: 0, 3: 0, 4: 0, 7: 3, 9: 3, 10: 3 };
  function Lj(a, b) {
    if ("" === a) return b;
    var c = Number(a);
    return isNaN(c) ? b : c;
  ...
  var Pj = function (a, b) {
    ...
    Xj = function () {
      ...
      if (
        ...
        !a.active &&
        ("function" === typeof G.__tcfapi || Ej(b))
      ) {
        a.active = !0;
        a.Ob = {};
        Tj();
        ...
        try {
          b.addEventListener(function (e) {
            ...
            if (0 !== e.internalErrorState) Uj(a), Vj(a), Qj(c);
            else {
              var f;
              a.gdprApplies = e.gdprApplies;
              if (!1 === e.gdprApplies) (f = Wj()), b.removeEventListener(e);
              else if (
  ...
  function Wj() {
    var a = {},
      b;
    for (b in Kj) Kj.hasOwnProperty(b) && (a[b] = !0);
    return a;
  }
  function Vj(a) {
    var b = {};
  ...
  var gk = function (a) {
    ...
    ok = function (a, b, c, d) {
      ...
      var p = n.F[0],
        ...
        J = gk(F);
      mk(J, d);
      var M = { prefix: A, domain: w, Mb: y, flags: z };
      if (q) {
        var N = t(C.ka) || {};
        if (x) {
          var P = t(C.sb),
      ...
      if (b === C.oa) {
        ...
        if (!q || (!u && !la))
          if ((!0 === t(C.be) && (u = !1), !1 !== t(C.fa) || u)) {
            ...
            !u && t(C.V) && (Q.google_gtag_event_data = { items: t(C.V) });
            if (u && b == C.na) {
    ...
    sk = function (a, b, c) {
      ...
      if (qk(d, a)) {
        ...
        if (a.od) {
          ...
          var x = Zg(u);
          x && d("gac", x);
          Pf({ prefix: a.fb, Mb: a.Kg, domain: a.Jg, flags: a.Mh });
          var A = Kf[Lf(a.fb)];
          A && d("auiddc", A);
        }
    ...
    Ak = function (a, b, c, d) {
      ...
      if (e) {
        ...
        if (b === C.oa) {
          ...
          var w = { prefix: k, domain: l, Mb: n, flags: q },
            y = f(C.ka) || {},
            z = f(C.sb),
            B = void 0 === z ? !0 : !!z;
          h &&
            (sg(y[C.$a], !!y[C.I]) && Og(yk, w),
            Mg(w),
            Rg(yk, w),
            zk ? $g(B, w) : ah(B, w));
  ...
  var Ck = function (a) {
      function b() {
        ...
        if (a.conversionLinkerEnabled) {
          ...
          if (h && h.length)
            for (var k = 0; k < h.length; k++) f += "&gclgf=" + Bk(h[k]);
        }
  ...
  var Dk = /.*\.google\.com(:\d+)?\/(?:booking|travel)\/flights.*/,
    Fk = function (a, b, c, d) {
      ...
      if (b === C.oa) {
        ...
        if (k) {
          var A = { prefix: l, domain: n, flags: p, Mb: q };
          Mg(A);
          Rg(["aw", "dc"], A);
        }
        I(d.onSuccess);
  ...
  var Tk = function (a, b) {
    ...
    cl = function (a, b, c) {
      var d =
          "/leagueoflegend/wp-content/cache/busting/google-tracking/ga-6a10eb2bb5c90414980729f4f96ffbda.js",
        e = ii();
      if (Ca(e)) {
        var f = "gtag_" + a.split("-").join("_"),
          ...
          k = function () {
            var w = function (E, F) {
                for (var J = 0; F && J < F.length; J++) h(E, F[J]);
              },
              y = Xk(b, c);
            if (y) {
              var z = y.action;
              if ("impressions" === z) w("ec:addImpression", y.$g);
        ...
        (function (w) {
          if (w) {
            var y = {};
            if (mb(w))
              for (var z in $k) $k.hasOwnProperty(z) && al($k[z], z, w[z], y);
            h("require", "linkid", y);
          }
        })(n.linkAttribution);
        var r = n[C.ka];
        ...
        b === C.Mc
          ? (l(), h("send", "pageview", n.Ha))
          : b === C.Z
          ? (l(),
            th(a, c),
            c.getWithConfig(C.Ea) && (Tg(), ki(f + ".")),
            0 != n.sendPageView && h("send", "pageview", n.Ha),
            Wk(a, f, c))
          : b === C.oa
          ? Tk(f, c)
          : "screen_view" === b
          ? h("send", "screenview", n.Ha)
          : "timing_complete" === b
    ...
    $k = { cookie_name: 1, cookie_expires: "duration", levels: 1 },
    gl = {
      anonymize_ip: 1,
      fatal: 1,
      non_interaction: 1,
    ...
    Uk = function (a, b, c, d) {
      ...
      for (var u = rj(d), t = 0; t < u.length; ++t) {
        var v = u[t],
          x = f(v);
        if (fl.hasOwnProperty(v)) al(fl[v], v, x, h);
        else if (Rk.hasOwnProperty(v)) al(Rk[v], v, x, k);
        else if (Qk.hasOwnProperty(v)) al(Qk[v], v, x, l);
      ...
      0 <=
        Ga(
          ...
          c
        ) && Zk(k, "nonInteraction", !0);
      "login" === c || "sign_up" === c || "share" === c
        ? Zk(h, "eventLabel", f(C.$f))
        : "search" === c || "view_search_results" === c
        ? Zk(h, "eventLabel", f(C.hg))
        : "select_content" === c && Zk(h, "eventLabel", f(C.Qf));
      var w = h[C.ka] || {},
        y = w[C.$a];
      y || (0 != y && w[C.I])
        ? (l.allowLinker = !0)
        : !1 === y && Zk(l, "useAmpClientId", !1);
      f(C.Ea) && (l._useUp = !0);
    ...
    Xk = function (a, b) {
      ...
      function d(v) {
        for (var x = [], A = 0; v && A < v.length; A++) v[A] && x.push(c(v[A]));
      ...
      var u = null,
        t = f(C.Wf);
      a === C.na || a === C.Xa
        ? (u = { action: a, Db: e(), ib: d(h) })
        : a === C.Va
        ? (u = { action: "add", ib: d(h) })
        : a === C.Wa
        ? (u = { action: "remove", ib: d(h) })
        : a === C.za
        ? (u = { action: "detail", Db: e(k), ib: d(h) })
        : a === C.Ub
        ? (u = { action: "impressions", $g: d(h) })
        : "view_promotion" === a
        ? (u = { action: "promo_view", Fd: d(t) })
        : "select_content" === a && t && 0 < t.length
        ? (u = { action: "promo_click", Fd: d(t) })
        : "select_content" === a
        ? (u = { action: "click", Db: { list: f(C.Pc) || k }, ib: d(h) })
        : a === C.Ka || "checkout_progress" === a
        ? (u = {
            action: "checkout",
            ib: d(h),
            Db: { step: a === C.Ka ? 1 : f(C.ne), option: f(C.me) },
          })
        : "set_checkout_option" === a &&
          (u = {
            action: "checkout_option",
            Db: { step: f(C.ne), option: f(C.me) },
          });
      u && (u.Nh = f(C.ja));
      return u;
    },
        ...
        if (f) {
          var h = m(c),
            ...
            u = pj(
              oj(
                qj(
                  nj(mj(lj(kj(jj(ij(h), k), l), n), q), function () {
                    Oi(p, r, "2");
                  }),
                  function () {
                    Oi(p, r, "3");
  ...
  aa.insert = function (a, b, c) {
    ...
    0 < this.m.length
      ? this.m.splice(1, 0, new tl(a, d, c, b, !1))
      : this.m.push(new tl(a, d, c, b, !1));
  };
  aa.flush = function (a) {
          ...
          if (c)
            if (Cl)
              new MutationObserver(function () {
                for (var e = 0; e < Dl.length; e++) I(Dl[e]);
  ...
  function Il() {
    if (!Gl) {
      Gl = !0;
      for (var a = 0; a < Hl.length; a++) I(Hl[a]);
    }
  }
  var Jl = function (a) {
    Gl ? I(a) : Hl.push(a);
  ...
  var Sl = {
      ...
      js: function (a) {
        if (2 == a.length && a[1].getTime)
          return (
            (Nl = !0), Pl(), { event: "gtm.js", "gtm.start": a[1].getTime() }
          );
      },
      policy: function () {},
      set: function (a) {
  ...
  var Tm = G.clearTimeout,
    ...
    $m = function (a, b, c) {
      var d;
      b
        ? ((a.eventCallback = b), c && (a.eventTimeout = c), (d = tm(a)))
        : (d = tm(a));
      return d;
    },
    an = function (a, b) {
  ...
  var gq = window,
    ...
    iq = function (a) {
      ...
      for (
        var d = mf("AMP_TOKEN", String(hq.cookie), !0), e = 0;
        e < d.length;
        e++
      )
  ...
  (Z.g.get = ["google"]),
    (function () {
      (function (a) {
        ...
        (a.vtp_deferrable
          ? rq
          : qq)(String(b.streamId), String(a.vtp_eventName), b.eventParameters || {});
        a.vtp_gtmOnSuccess();
      });
    })();
  (Z.g.gtagfl = []),
